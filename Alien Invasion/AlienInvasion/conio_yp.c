...
// - this file is exactly the same as the conio.c
//   found in the include directory of Dev-Cpp 4.9.8.4
//
// ver 031102 02-Nov-2003
// - function for hideCursor() and hideCursor() added 
...
// use this function to hide cursor 
void hideCursor ()
{
...
// use this function to un-hide (show) cursor 
void showCursor ()
{
    CONSOLE_CURSOR_INFO Info;
    Info.bVisible = TRUE;
